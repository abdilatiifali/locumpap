<template>
    <footer class="bg-gray-800" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="pb-8">
                <div class="#">
                    <div class="flex justify-between md:gap-8">
                        <div class="#">
                            <h3
            ...
            >
                ...
                <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
                    &copy; 2022 Local Pap, Inc. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
...
const navigation = {
    company: [
        { name: "Locums", href: "/im-a-locum" },
        { name: "Looking for locum", href: "/looking-for-a-locum" },
    ...
    legal: [
        {
            name: "Terms & condition for locums",
